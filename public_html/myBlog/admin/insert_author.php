    ...
    <section class="hero2 d-flex align-items-center">
        <div class="container">
            <div class="d-flex justify-content-center">
                <h1 class="fw-bold text-white">Add Author</h1>
            </div>
        ...
        <div class="w-50">
            <form action="http://localhost/myBlog/admin/php/add_author.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="email" type="text" class="form-control" id="Name" placeholder="Naruto">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Password</label>
                    <input name="password" type="text" class="form-control" id="Subject" placeholder="Subject">
                </div>
                <div class="col-auto">
                    <button name="submit" type="submit" class="btn btn-primary mb-3 my-4">Register</button>
                </div>
